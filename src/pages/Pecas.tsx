  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
              ...
              <TableRow>
                ...
                <TableCell>
                  <TableSortLabel
                    ...
                    direction={
                      ordenacao.campo === "codigo" ? ordenacao.direcao : "asc"
                    }
                ...
                <TableCell>
                  <TableSortLabel
                    ...
                    direction={
                      ordenacao.campo === "preco" ? ordenacao.direcao : "asc"
                    }
      ...
      <Dialog open={openDelete} onClose={handleCloseDelete}>
        ...
        <DialogContent>
          <Typography>
            Tem certeza que deseja excluir esta peça? Esta ação não pode ser
            desfeita.
          </Typography>
        </DialogContent>
        <DialogActions>
